...
namespace MailingSystem.Migrations.ConfigurationDb
{
    ...
    [Migration("20221221001132_UpdateMailConfig")]
    partial class UpdateMailConfig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MailingSystem.Entities.MailsUserSettings", b =>
                {
                    ...
                    b.Property<string>("RecipientsSheetId")
                        .IsRequired()
                        .HasMaxLength(55)
                        .HasColumnType("nvarchar(55)");

                    b.Property<int>("ReminderMailsHowManyWeeksAfter")
                        .HasColumnType("int");
